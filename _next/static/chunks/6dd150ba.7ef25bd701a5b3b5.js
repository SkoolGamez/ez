              ...
              3614: (e, t) => {
                ...
                Object.defineProperty(t, "__esModule", { value: !0 }),
                  ...
                  (t.handlePasteEvent = function (e, t, i, s) {
                    e.stopPropagation(),
                      e.clipboardData &&
                        r(e.clipboardData.getData("text/plain"), t, i, s);
                  }),
                  (t.paste = r),
                  ...
                  l = (t.Linkifier2 = class extends a.Disposable {
                    ...
                    registerLinkProvider(e) {
                      return (
                        ...
                        {
                          dispose: () => {
                            let t = this._linkProviders.indexOf(e);
                    ...
                    _askForLink(e, t) {
                      ...
                      let r = !1;
                      for (let [i, n] of this._linkProviders.entries())
                        t
                      ...
                      for (let t = 0; t < h; t++)
                        if (-1 !== c || s.hasContent(t)) {
                          ...
                          if (d || (-1 !== c && t === h - 1)) {
                            let s =
                              null ===
                                (i = this._oscLinkService.getLinkData(l)) ||
                              void 0 === i
                                ? void 0
                                : i.uri;
                            if (s) {
                              let i = {
                                ...
                                n = !1;
                              if (
                                !(null == o ? void 0 : o.allowNonHttpProtocols)
                              )
                                try {
                                  let e = new URL(s);
...
WARNING: This link could potentially be dangerous`)
                ...
                class P extends y.CoreTerminal {
                          ...
                          case 1:
                            if ("ansi" === e)
                              this._themeService.modifyColors(
                                (e) =>
                                  (e.ansi[t.index] = b.rgba.toColor(...t.color))
                              );
                            else {
                              let i = e;
                              this._themeService.modifyColors(
                  ...
                  _handleTextAreaFocus(e) {
                    this.coreService.decPrivateModes.sendFocus &&
                      this.coreService.triggerDataEvent(L.C0.ESC + "[I"),
                  ...
                  _handleTextAreaBlur() {
                    (this.textarea.value = ""),
                      ...
                      this.coreService.decPrivateModes.sendFocus &&
                        this.coreService.triggerDataEvent(L.C0.ESC + "[O"),
                  ...
                  _initGlobal() {
                    this._bindKeys(),
                      this.register(
                        (0, r.addDisposableDomListener)(
                          ...
                          (e) => {
                            this.hasSelection() &&
                              (0, s.copyHandler)(e, this._selectionService);
                          }
                        )
                      );
                    let e = (e) =>
                      (0, s.handlePasteEvent)(
                        e,
                        this.textarea,
                        this.coreService,
                        this.optionsService
                    ...
                    this.register(
                      (0, r.addDisposableDomListener)(this.textarea, "paste", e)
                    ),
                      this.register(
                        (0, r.addDisposableDomListener)(
                          this.element,
                    ...
                    (this._viewportElement = O.createElement("div")),
                      ...
                      (this._coreBrowserService =
                        this._instantiationService.createInstance(
                          ...
                          this.textarea,
                          null !== (t = this._document.defaultView) &&
                            void 0 !== t
                            ? t
                            : window
                        )),
                  ...
                  bindMouse() {
                    ...
                    function i(t) {
                      let i, s;
                      let r = e._mouseService.getMouseReportCoords(
                        t,
                        e.screenElement
                      );
                      if (!r) return !1;
                      ...
                      this.coreMouseService.onProtocolChange((e) => {
                        e
                          ...
                          8 & e
                            ...
                            : (t.removeEventListener("mousemove", s.mousemove),
                              (s.mousemove = null)),
                          16 & e
                            ? s.wheel ||
                              (t.addEventListener("wheel", n.wheel, {
                                passive: !1,
                              }),
                              (s.wheel = n.wheel))
                  ...
                  _keyDown(e) {
                    ...
                    let i = (0, D.evaluateKeyboardEvent)(
                      e,
                    ...
                    if (
                      (this.updateCursorStyle(e), 3 === i.type || 2 === i.type)
                    ) {
                      let t = this.rows - 1;
                      return (
                    ...
                    if (0 !== this.buffer.ybase || 0 !== this.buffer.y) {
                      ...
                      for (let e = 1; e < this.rows; e++)
                        this.buffer.lines.push(
                          this.buffer.getBlankLine(x.DEFAULT_ATTR_DATA)
                        );
                      this._onScroll.fire({
                        position: this.buffer.ydisp,
                        source: 0,
                      }),
                        null === (e = this.viewport) ||
                          void 0 === e ||
                          e.reset(),
                        this.refresh(0, this.rows - 1);
                    }
                ...
                let n = i(3656),
                  ...
                  l = (t.BufferDecorationRenderer = class extends a.Disposable {
                    ...
                    _createElement(e) {
                      ...
                      let r =
                        null !== (i = e.options.x) && void 0 !== i ? i : 0;
                      return (
                        r &&
                ...
                Object.defineProperty(t, "__esModule", { value: !0 }),
                  ...
                  (t.ColorZoneStore = class {
                    ...
                    _lineAdjacentToZone(e, t, i) {
                      return (
                        t >=
                          e.startBufferLine - this._linePadding[i || "full"] &&
                  ...
                  u = (t.OverviewRulerRenderer = class extends h.Disposable {
                    ...
                    constructor(e, t, i, s, r, o, a) {
                      ...
                      super(),
                        ...
                        null === (l = this._viewportElement.parentElement) ||
                          void 0 === l ||
                          l.insertBefore(this._canvas, this._viewportElement);
                    ...
                    _refreshDecorations() {
                      for (let e of (this._shouldUpdateDimensions &&
                        this._refreshCanvasDimensions(),
                      this._ctx.clearRect(
                        0,
                        0,
                      ...
                      this._decorationService.decorations))
                        ...
                        if (this._bufferService.buffer.isCursorInViewport) {
                          let e = Math.min(
                            ...
                            i =
                              ...
                              this._renderService.dimensions.css.cell.height,
                            s =
                              e * this._renderService.dimensions.css.cell.width;
              ...
              9806: (e, t) => {
                ...
                Object.defineProperty(t, "__esModule", { value: !0 }),
                  ...
                  (t.getCoords = function (e, t, s, r, n, o, a, h, l) {
                    if (!o) return;
                    let c = i(e, t, s);
                    return c
                      ? ((c[0] = Math.ceil((c[0] + (l ? a / 2 : 0)) / a)),
                        (c[1] = Math.ceil(c[1] / h)),
                        (c[0] = Math.min(Math.max(c[0], 1), r + (l ? 1 : 0))),
                        (c[1] = Math.min(Math.max(c[1], 1), n)),
                        c)
                      : void 0;
                  });
              },
              9504: (e, t, i) => {
                ...
                function o(e, t, i, s, r, n) {
                  ...
                  for (; o !== i || a !== s; )
                    (o += r ? 1 : -1),
                      r && o > n.cols - 1
                        ? ((h += n.buffer.translateBufferLineToString(
                            a,
                            !1,
                            e,
                            o
                ...
                t.moveToCellSequence = function (e, t, i, s) {
                  ...
                  if (!i.buffer.hasScrollback)
                    return (
                      (0 === r(_, t, i, s).length
                        ? ""
                        : h(o(d, _, d, _ - n(_, i), !1, i).length, a("D", s))) +
                      r(_, t, i, s) +
                      (function (e, t, i, s, l, c) {
                        let d, _;
                        d = r(t, s, l, c).length > 0 ? s - n(s, l) : t;
                        let u =
                          ((_ = r(i, s, l, c).length > 0 ? s - n(s, l) : t),
                          (e < i && _ <= s) || (e >= i && _ < s) ? "C" : "D");
                        return h(o(e, d, i, s, "C" === u, l).length, a(u, c));
                      })(d, _, e, t, i, s)
                    );
                  if (_ === t)
                    return (c = d > e ? "D" : "C"), h(Math.abs(d - e), a(c, s));
                  c = _ > t ? "D" : "C";
                  let u = Math.abs(_ - t);
                  return h(
                    ((l = _ > t ? e : d),
                    i.cols - l + (u - 1) * i.cols + 1 + ((_ > t ? d : e) - 1)),
                    a(c, s)
                  );
                };
              },
                ...
                let n = i(3787),
                  ...
                  b = (t.DomRenderer = class extends _.Disposable {
                    ...
                    _updateDimensions() {
                      ...
                      for (let t of ((this.dimensions.device.char.width =
                      ...
                      (this.dimensions.css.cell.height =
                        ...
                        this._bufferService.rows),
                      this._rowElements))
                        (t.style.width = `${this.dimensions.css.canvas.width}px`),
                          (t.style.height = `${this.dimensions.css.cell.height}px`),
                          (t.style.lineHeight = `${this.dimensions.css.cell.height}px`),
                    ...
                    _injectCss(e) {
                      ...
                      for (let [i, s] of ((t +=
                        `${this._terminalSelector} .${v} .xterm-dim { color: ${
                          c.color.multiplyOpacity(e.foreground, 0.5).css
                        };}${
                          this._terminalSelector
                        } span:not(.xterm-bold) { font-weight: ${
                          this._optionsService.rawOptions.fontWeight
                        };}${
                          this._terminalSelector
                        } span.xterm-bold { font-weight: ${
                          this._optionsService.rawOptions.fontWeightBold
                        };}${
                          this._terminalSelector
                        } span.xterm-italic { font-style: italic;}@keyframes blink_box_shadow_` +
                        this._terminalClass +
                        ...
                        `${this._terminalSelector} .${S} { position: absolute; top: 0; left: 0; z-index: 1; pointer-events: none;}${this._terminalSelector}.focus .${S} div { position: absolute; background-color: ${e.selectionBackgroundOpaque.css};}${this._terminalSelector} .${S} div { position: absolute; background-color: ${e.selectionInactiveBackgroundOpaque.css};}`),
                      e.ansi.entries()))
                        t += `${this._terminalSelector} .${g}${i} { color: ${
                          s.css
                        }; }${
                          this._terminalSelector
                        } .${g}${i}.xterm-dim { color: ${
                          c.color.multiplyOpacity(s, 0.5).css
                        }; }${
                          this._terminalSelector
                        } .${p}${i} { background-color: ${s.css}; }`;
                      (t += `${this._terminalSelector} .${g}${
                        a.INVERTED_DEFAULT_COLOR
                      } { color: ${c.color.opaque(e.background).css}; }${
                        this._terminalSelector
                      } .${g}${a.INVERTED_DEFAULT_COLOR}.xterm-dim { color: ${
                        c.color.multiplyOpacity(
                          c.color.opaque(e.background),
                          0.5
                        ).css
                    ...
                    _createSelectionElement(e, t, i, s = 1) {
                      ...
                      return (
                        ...
                        (r.style.left =
                          t * this.dimensions.css.cell.width + "px"),
                        (r.style.width =
                ...
                let n = i(2223),
                  ...
                  f = (t.DomRendererRowFactory = class {
                      ...
                      for (let M = 0; M < b; M++) {
                        ...
                        if (
                          (" " === N &&
                            ...
                            (N = "\xa0"),
                          (A = b * c - _.get(N, I.isBold(), I.isItalic())),
                          C)
                        ) {
                          if (
                            y &&
                            ((H && R) || (!H && !R && I.bg === E)) &&
                            ((H && R && S.selectionForeground) || I.fg === k) &&
                            I.extended.ext === x &&
                            W === L &&
                            A === D &&
                            !F &&
                        ...
                        if (
                          ...
                          if (I.isUnderlineColorRGB())
                            C.style.textDecorationColor = `rgb(${u.AttributeData.toColorRGB(
                              I.getUnderlineColor()
                            ).join(",")})`;
                          else {
                            ...
                            (e) => {
                              ("top" !== e.options.layer && J) ||
                                (e.backgroundColorRGB &&
                                  ((K = 50331648),
                                  (z =
                                    (e.backgroundColorRGB.rgba >> 8) &
                                    16777215),
                                  (V = e.backgroundColorRGB)),
                                e.foregroundColorRGB &&
                                  ((j = 50331648),
                                  ($ =
                                    (e.foregroundColorRGB.rgba >> 8) &
                                    16777215),
                          ...
                          !J &&
                            ...
                            ((z =
                              ((V = this._coreBrowserService.isFocused
                                ...
                                : S.selectionInactiveBackgroundOpaque).rgba >>
                                8) &
                              16777215),
                            (K = 50331648),
                            (J = !0),
                        ...
                        switch (
                          (V ||
                            (I.isDim() &&
                              (V = l.color.multiplyOpacity(X, 0.5))),
                          j)
                        ) {
                          case 16777216:
                          case 33554432:
                            ...
                            break;
                          case 50331648:
                            let Y = l.rgba.toColor(
                              ($ >> 16) & 255,
                              ($ >> 8) & 255,
                              255 & $
                            );
                            this._applyMinimumContrast(C, X, Y, I, V, G) ||
                              this._addStyle(
                                C,
                    ...
                    _applyMinimumContrast(e, t, i, s, r, n) {
                      ...
                      if (
                        (r || n || (o = a.getColor(t.rgba, i.rgba)),
                        void 0 === o)
                      ) {
                        let e =
                          this._optionsService.rawOptions.minimumContrastRatio /
                          (s.isDim() ? 2 : 1);
                        (o = l.color.ensureContrastRatio(r || t, n || i, e)),
                          a.setColor(
                            (r || t).rgba,
                            (n || i).rgba,
                            null != o ? o : null
              ...
              2223: (e, t, i) => {
                ...
                (t.INVERTED_DEFAULT_COLOR = 257),
                  (t.DIM_OPACITY = 0.5),
                  (t.TEXT_BASELINE =
                    s.isFirefox || s.isLegacyEdge ? "bottom" : "ideographic");
              },
              6171: (e, t) => {
                function i(e) {
                  ...
                  u = (t.RenderService = class extends c.Disposable {
                    ...
                    constructor(e, t, i, s, r, h, _, u) {
                      if (
                        ...
                        (this._onRender = this.register(new l.EventEmitter())),
                        (this.onRender = this._onRender.event),
                        ...
                        (this._screenDprMonitor = new a.ScreenDprMonitor(
                          _.window
                        )),
                        this._screenDprMonitor.setListener(() =>
                        ...
                        this.register(
                          h.buffers.onBufferActivate(() => {
                            var e;
                            return null === (e = this._renderer.value) ||
                              void 0 === e
                              ? void 0
                              : e.clear();
                          })
                        ...
                        this.register(
                          r.onDecorationRegistered(() => this._fullRefresh())
                        ),
                        this.register(
                          r.onDecorationRemoved(() => this._fullRefresh())
                        ),
                        this.register(
                        ...
                        this.register(
                          u.onChangeColors(() => this._fullRefresh())
                        ),
                        "IntersectionObserver" in _.window)
                      ) {
                        let e = new _.window.IntersectionObserver(
                          (e) =>
                            this._handleIntersectionChange(e[e.length - 1]),
                          { threshold: 0 }
                        );
                        e.observe(t),
                          this.register({ dispose: () => e.disconnect() });
                      }
                    }
                    ...
                    clearTextureAtlas() {
                      ...
                      this._renderer.value &&
                        (null ===
                          (t = (e = this._renderer.value).clearTextureAtlas) ||
                          void 0 === t ||
                          t.call(e),
                        this._fullRefresh());
                    }
                  ...
                  p = (t.SelectionService = class extends c.Disposable {
                    ...
                    get selectionText() {
                      ...
                      if (3 === this._activeSelectionMode) {
                        ...
                        s.push(
                          i.translateBufferLineToString(e[1], !0, e[0], r)
                        );
                    ...
                    _isClickInSelection(e) {
                      ...
                      return (
                        !!(i && s && t) && this._areCoordsInSelection(t, i, s)
                      );
                    }
                    isCellInSelection(e, t) {
                      let i = this._model.finalSelectionStart,
                        s = this._model.finalSelectionEnd;
                      return (
                        !(!i || !s) && this._areCoordsInSelection([e, t], i, s)
                      );
                    }
                    ...
                    _selectWordAtCursor(e, t) {
                      ...
                      let r =
                        null ===
                          (s =
                            null === (i = this._linkifier.currentLink) ||
                            void 0 === i
                              ? void 0
                              : i.link) || void 0 === s
                          ? void 0
                      ...
                      if (r)
                        return (
                          ...
                          _.getRangeLength)(r, this._bufferService.cols)),
                    ...
                    _getMouseEventScrollAmount(e) {
                      ...
                      return t >= 0 && t <= i
                        ? 0
                        : (t > i && (t -= i),
                          (t = Math.min(Math.max(t, -50), 50) / 50) /
                            Math.abs(t) +
                            Math.round(14 * t));
                    }
                    ...
                    _selectWordAt(e, t) {
                      ...
                      if (i) {
                        for (; i.start < 0; )
                          (i.start += this._bufferService.cols), e[1]--;
                    ...
                    _selectLineAt(e) {
                      ...
                      (this._model.selectionStart = [0, t.first]),
                        (this._model.selectionEnd = void 0),
                        (this._model.selectionStartLength = (0,
                        _.getRangeLength)(i, this._bufferService.cols));
                    }
                  });
                t.SelectionService = s(
                  [
                ...
                let v = (t.ThemeService = class extends h.Disposable {
                  ...
                  _setTheme(e = {}) {
                    ...
                    if (
                      ...
                      (i.ansi[0] = g(e.black, t.DEFAULT_ANSI_COLORS[0])),
                      (i.ansi[1] = g(e.red, t.DEFAULT_ANSI_COLORS[1])),
                      (i.ansi[2] = g(e.green, t.DEFAULT_ANSI_COLORS[2])),
                      (i.ansi[3] = g(e.yellow, t.DEFAULT_ANSI_COLORS[3])),
                      (i.ansi[4] = g(e.blue, t.DEFAULT_ANSI_COLORS[4])),
                      (i.ansi[5] = g(e.magenta, t.DEFAULT_ANSI_COLORS[5])),
                      (i.ansi[6] = g(e.cyan, t.DEFAULT_ANSI_COLORS[6])),
                      (i.ansi[7] = g(e.white, t.DEFAULT_ANSI_COLORS[7])),
                      (i.ansi[8] = g(e.brightBlack, t.DEFAULT_ANSI_COLORS[8])),
                      (i.ansi[9] = g(e.brightRed, t.DEFAULT_ANSI_COLORS[9])),
                      (i.ansi[10] = g(
                        e.brightGreen,
                      ...
                      (i.ansi[12] = g(e.brightBlue, t.DEFAULT_ANSI_COLORS[12])),
                      (i.ansi[13] = g(
                        e.brightMagenta,
                        t.DEFAULT_ANSI_COLORS[13]
                      )),
                      (i.ansi[14] = g(e.brightCyan, t.DEFAULT_ANSI_COLORS[14])),
                      (i.ansi[15] = g(
                        e.brightWhite,
                    ...
                    if (t) {
                      for (let i = e; i < this._length - t; i++)
                        this._array[this._getCyclicIndex(i)] =
                          this._array[this._getCyclicIndex(i + t)];
                      (this._length -= t),
              ...
              8055: (e, t, i) => {
                ...
                (t.NULL_COLOR = { css: "#00000000", rgba: 0 }),
                  ((h = s || (t.channels = s = {})).toCss = function (
                    e,
                    t,
                    i,
                    s
                  ...
                  (function (e) {
                    function t(e, t) {
                      return (
                        (u = Math.round(255 * t)),
                        ([c, d, _] = a.toChannels(e.rgba)),
                        { css: s.toCss(c, d, _, u), rgba: s.toRgba(c, d, _, u) }
                      );
                    }
                    (e.blend = function (e, t) {
                      if (1 == (u = (255 & t.rgba) / 255))
                      ...
                      let i = (t.rgba >> 24) & 255,
                        ...
                        h = (e.rgba >> 8) & 255;
                      return (
                        (c = o + Math.round((i - o) * u)),
                        (d = a + Math.round((r - a) * u)),
                        (_ = h + Math.round((n - h) * u)),
                        { css: s.toCss(c, d, _), rgba: s.toRgba(c, d, _) }
                      );
                    }),
                      ...
                      (e.opaque = function (e) {
                        let t = (255 | e.rgba) >>> 0;
                        return (
                          ([c, d, _] = a.toChannels(t)),
                          { css: s.toCss(c, d, _), rgba: t }
                        );
                      }),
                      (e.opacity = t),
                  ...
                  (function (e) {
                    ...
                    if (!l.isNode) {
                      ...
                      let s = e.getContext("2d", { willReadFrequently: !0 });
                      s &&
                        (((t = s).globalCompositeOperation = "copy"),
                    ...
                    e.toColor = function (e) {
                      if (e.match(/#[\da-f]{3,8}/i))
                        switch (e.length) {
                          case 4:
                            return (
                              (c = parseInt(e.slice(1, 2).repeat(2), 16)),
                              (d = parseInt(e.slice(2, 3).repeat(2), 16)),
                              (_ = parseInt(e.slice(3, 4).repeat(2), 16)),
                              a.toColor(c, d, _)
                            );
                          case 5:
                            return (
                      ...
                      if (r)
                        return (
                          ...
                          (_ = parseInt(r[3])),
                          (u = Math.round(
                            255 * (void 0 === r[5] ? 1 : parseFloat(r[5]))
                          )),
                          a.toColor(c, d, _, u)
                        );
                      if (
                        ...
                        (t.fillRect(0, 0, 1, 1),
                        ([c, d, _, u] = t.getImageData(0, 0, 1, 1).data),
                        255 !== u)
                      )
                        throw Error("css.toColor: Unsupported css format");
                      return { rgba: s.toRgba(c, d, _, u), css: e };
                    };
                  })(n || (t.css = n = {})),
                  (function (e) {
                    function t(e, t, i) {
                  ...
                  (function (e) {
                    function t(e, t, i) {
                      let s = (e >> 24) & 255,
                        ...
                        l = (t >> 8) & 255,
                        c = v(
                          o.relativeLuminance2(a, h, l),
                          o.relativeLuminance2(s, r, n)
                        );
                      for (; c < i && (a > 0 || h > 0 || l > 0); )
                    ...
                    (e.ensureContrastRatio = function (e, s, r) {
                      ...
                      if (v(n, a) < r) {
                        if (a < n) {
                          ...
                          if (h < r) {
                            let t = i(e, s, r);
                            return h > v(n, o.relativeLuminance(t >> 8))
                              ? a
                              : t;
                          }
                          return a;
                ...
                class S extends s.Disposable {
                  ...
                  _handleWindowsPtyOptionChange() {
                    ...
                    t && void 0 !== t.buildNumber && void 0 !== t.buildNumber
                      ? (e = !!(
                          "conpty" === t.backend && t.buildNumber < 21376
                        ))
              ...
              5435: function (e, t, i) {
                ...
                ((s = r || (t.WindowsOptionsReportType = r = {}))[
                  (s.GET_WIN_SIZE_PIXELS = 0)
                ] = "GET_WIN_SIZE_PIXELS"),
                  (s[(s.GET_CELL_SIZE_PIXELS = 1)] = "GET_CELL_SIZE_PIXELS");
                let w = 0;
                class E extends c.Disposable {
                  ...
                  constructor(
                    ...
                    (this._stringDecoder = new d.StringToUtf32()),
                    (this._utf8Decoder = new d.Utf8ToUtf32()),
                    (this._workCell = new v.CellData()),
                    (this._windowTitle = ""),
                    (this._iconName = ""),
                    (this._windowTitleStack = []),
                    (this._iconNameStack = []),
                    (this._curAttrData = _.DEFAULT_ATTR_DATA.clone()),
                    ...
                    this._parser.registerOscHandler(
                      1,
                      new m.OscHandler((e) => this.setIconName(e))
                    ),
                    this._parser.registerOscHandler(
                      2,
                      new m.OscHandler((e) => this.setTitle(e))
                    ),
                    this._parser.registerOscHandler(
                      4,
                      new m.OscHandler((e) => this.setOrReportIndexedColor(e))
                    ),
                    this._parser.registerOscHandler(
                      8,
                      new m.OscHandler((e) => this.setHyperlink(e))
                    ),
                    this._parser.registerOscHandler(
                      10,
                      new m.OscHandler((e) => this.setOrReportFgColor(e))
                    ),
                    this._parser.registerOscHandler(
                      11,
                      new m.OscHandler((e) => this.setOrReportBgColor(e))
                    ),
                    this._parser.registerOscHandler(
                      12,
                      new m.OscHandler((e) => this.setOrReportCursorColor(e))
                    ),
                    this._parser.registerOscHandler(
                      104,
                      new m.OscHandler((e) => this.restoreIndexedColor(e))
                    ),
                    this._parser.registerOscHandler(
                      110,
                      new m.OscHandler((e) => this.restoreFgColor(e))
                    ),
                    this._parser.registerOscHandler(
                      111,
                      new m.OscHandler((e) => this.restoreBgColor(e))
                    ),
                    this._parser.registerOscHandler(
                      112,
                      new m.OscHandler((e) => this.restoreCursorColor(e))
                    ),
                  ...
                  _logSlowResolvingAsync(e) {
                    this._logService.logLevel <= p.LogLevelEnum.WARN &&
                      Promise.race([
                        e,
                        new Promise((e, t) =>
                  ...
                  parse(e, t) {
                    ...
                    if (o) {
                      ...
                      (s = this._parseStack.cursorStartX),
                        ...
                        e.length > 131072 &&
                          (n = this._parseStack.position + 131072);
                    }
                    if (
                      (this._logService.logLevel <= p.LogLevelEnum.DEBUG &&
                        this._logService.debug(
                          "parsing data" +
                            ("string" == typeof e
                              ? ` "${e}"`
                  ...
                  print(e, t, i) {
                    ...
                    let n = this._charsetService.charset,
                      ...
                      c = this._curAttrData,
                      _ = this._activeBuffer.lines.get(
                        this._activeBuffer.ybase + this._activeBuffer.y
                      );
                    this._dirtyRowTracker.markDirty(this._activeBuffer.y),
                      this._activeBuffer.x &&
                        i - t > 0 &&
                        2 === _.getWidth(this._activeBuffer.x - 1) &&
                    ...
                    for (let u = t; u < i; ++u) {
                      ...
                      if (
                        (o &&
                          this._onA11yChar.fire((0, d.stringFromCodePoint)(s)),
                        ...
                        if (
                          (l &&
                            (_.insertCells(
                              this._activeBuffer.x,
                              r,
                              this._activeBuffer.getNullCell(c),
                              c
                            ),
                            2 === _.getWidth(a - 1) &&
                              _.setCellFromCodePoint(
                        ...
                        _.getWidth(this._activeBuffer.x - 1)
                          ? _.addCodepointToCell(this._activeBuffer.x - 1, s)
                          : _.addCodepointToCell(this._activeBuffer.x - 2, s);
                    }
                    i - t > 0 &&
                      (_.loadCell(this._activeBuffer.x - 1, this._workCell),
                      2 === this._workCell.getWidth() ||
                      ...
                      this._activeBuffer.x < a &&
                        i - t > 0 &&
                        0 === _.getWidth(this._activeBuffer.x) &&
                        !_.hasContent(this._activeBuffer.x) &&
                        _.setCellFromCodePoint(
                          this._activeBuffer.x,
                          0,
                          1,
                  ...
                  _resetBufferLine(e, t = !1) {
                    let i = this._activeBuffer.lines.get(
                      this._activeBuffer.ybase + e
                    );
                    i &&
                      (i.fill(
                  ...
                  eraseInDisplay(e, t = !1) {
                    ...
                    switch (
                      ...
                      case 1:
                        for (
                          i = this._activeBuffer.y,
                            ...
                            this._activeBuffer.x + 1 >=
                              this._bufferService.cols &&
                              (this._activeBuffer.lines.get(i + 1).isWrapped =
                                !1);
                          i--;
                      ...
                      case 2:
                        for (
                          i = this._bufferService.rows,
                            this._dirtyRowTracker.markDirty(i - 1);
                          i--;
                  ...
                  deleteLines(e) {
                    ...
                    for (
                      ...
                      this._activeBuffer.lines.splice(s, 1),
                        this._activeBuffer.lines.splice(
                          t,
                          0,
                          this._activeBuffer.getBlankLine(this._eraseAttrData())
                      ...
                      this._activeBuffer.lines.splice(
                        ...
                        this._activeBuffer.lines.splice(
                          this._activeBuffer.ybase +
                            this._activeBuffer.scrollTop,
                          0,
                          this._activeBuffer.getBlankLine(_.DEFAULT_ATTR_DATA)
                        );
                    return (
                      this._dirtyRowTracker.markRangeDirty(
                        this._activeBuffer.scrollTop,
                  ...
                  requestMode(e, t) {
                    ...
                    let s = this._coreService.decPrivateModes,
                      { activeProtocol: r, activeEncoding: n } =
                        this._coreMouseService,
                      o = this._coreService,
                      { buffers: h, cols: l } = this._bufferService,
                      { active: c, alt: d } = h,
                    ...
                    return (
                      (i = t
                        ? 2 === f
                          ...
                          : 0
                        : 1 === f
                        ? u(s.applicationCursorKeys)
                        : 3 === f
                        ? _.windowOptions.setWinLines
                          ? 80 === l
                            ? 2
                            : 132 === l
                            ? 1
                        ...
                        ? u(!o.isCursorHidden)
                        : 45 === f
                        ? u(s.reverseWraparound)
                        : 66 === f
                        ? u(s.applicationKeypad)
                        : 67 === f
                        ? 4
                        : 1e3 === f
                        ? u("VT200" === r)
                  ...
                  _updateAttrColor(e, t, i, s, r) {
                    return (
                      2 === t
                        ? ((e |= 50331648),
                          (e &= -16777216),
                          (e |= g.AttributeData.fromColorRGB([i, s, r])))
                        : 5 === t &&
                          ((e &= -50331904), (e |= 33554432 | (255 & i))),
                      e
                    );
                  }
                  _extractColor(e, t, i) {
                    ...
                    do {
                      if (
                        ((s[n + r] = e.params[t + n]), e.hasSubParams(t + n))
                      ) {
                  ...
                  _processSGR0(e) {
                    (e.fg = _.DEFAULT_ATTR_DATA.fg),
                      (e.bg = _.DEFAULT_ATTR_DATA.bg),
                  ...
                  charAttributes(e) {
                    ...
                    let i = e.length,
                      s = this._curAttrData;
                    for (let r = 0; r < i; r++)
                      (t = e.params[r]) >= 30 && t <= 37
                        ? ((s.fg &= -50331904), (s.fg |= 16777216 | (t - 30)))
                        : t >= 40 && t <= 47
                        ? ((s.bg &= -50331904), (s.bg |= 16777216 | (t - 40)))
                        : t >= 90 && t <= 97
                        ? ((s.fg &= -50331904), (s.fg |= 16777224 | (t - 90)))
                        : t >= 100 && t <= 107
                        ? ((s.bg &= -50331904), (s.bg |= 16777224 | (t - 100)))
                        : 0 === t
                        ? this._processSGR0(s)
                        : 1 === t
                        ? (s.fg |= 134217728)
                        ...
                        ? (s.bg &= -67108865)
                        : 24 === t
                        ? ((s.fg &= -268435457), this._processUnderline(0, s))
                        : 25 === t
                        ? (s.fg &= -536870913)
                        : 27 === t
                        ? (s.fg &= -67108865)
                        ...
                        : 39 === t
                        ? ((s.fg &= -67108864),
                          (s.fg |= 16777215 & _.DEFAULT_ATTR_DATA.fg))
                        : 49 === t
                        ? ((s.bg &= -67108864),
                          (s.bg |= 16777215 & _.DEFAULT_ATTR_DATA.bg))
                        : 38 === t || 48 === t || 58 === t
                  ...
                  setCursorStyle(e) {
                    ...
                    return (
                      (this._optionsService.options.cursorBlink = t % 2 == 1),
                      !0
                    );
                  }
                  setScrollRegion(e) {
                    ...
                    return (
                      (e.length < 2 ||
                        ...
                        (t = this._bufferService.rows),
                      t > i &&
                        ((this._activeBuffer.scrollTop = i - 1),
                      ...
                      case 14:
                        2 !== t &&
                          this._onRequestWindowsOptionsReport.fire(
                            r.GET_WIN_SIZE_PIXELS
                          );
                        break;
                      case 16:
                        this._onRequestWindowsOptionsReport.fire(
                          r.GET_CELL_SIZE_PIXELS
                        );
                        break;
                      case 18:
                        this._bufferService &&
                  ...
                  setTitle(e) {
                    return (
                      (this._windowTitle = e), this._onTitleChange.fire(e), !0
                    );
                  }
                  setIconName(e) {
                  ...
                  _setOrReportSpecialColor(e, t) {
                    ...
                    for (
                      let e = 0;
                      e < i.length && !(t >= this._specialColors.length);
                      ++e, ++t
                    )
                      if ("?" === i[e])
                        this._onColor.fire([
                    ...
                    return (
                      2 !== e.length
                        ...
                        : "/" === e[0] ||
                          this._charsetService.setgCharset(
                            b[e[0]],
                            h.CHARSETS[e[1]] || h.DEFAULT_CHARSET
                          ),
                      !0
                    );
                  }
                  ...
                  tabSet() {
                    return (
                      (this._activeBuffer.tabs[this._activeBuffer.x] = !0), !0
                    );
                  }
                  reverseIndex() {
                    if (
                  ...
                  screenAlignmentPattern() {
                    ...
                    for (let t = 0; t < this._bufferService.rows; ++t) {
                      let i =
                          this._activeBuffer.ybase + this._activeBuffer.y + t,
                    ...
                    return (
                      (i =
                        '"q' === e
                          ...
                          ? 'P1$r61;1"p'
                          : "r" === e
                          ? `P1$r${s.scrollTop + 1};${s.scrollBottom + 1}r`
                          : "m" === e
                          ? "P1$r0m"
                          : " q" === e
                          ? `P1$r${
              ...
              844: (e, t) => {
                ...
                Object.defineProperty(t, "__esModule", { value: !0 }),
                  ...
                  (t.Disposable = class {
                    ...
                    dispose() {
                      for (let e of ((this._isDisposed = !0),
                      this._disposables))
                        e.dispose();
              ...
              6106: (e, t) => {
                ...
                t.SortedList = class {
                  ...
                  *getKeyIterator(e) {
                    if (
                      0 !== this._array.length &&
                      !((i = this._search(e)) < 0 || i >= this._array.length) &&
                      this._getKey(this._array[i]) === e
                    )
                      do yield this._array[i];
                      while (
                        ++i < this._array.length &&
                        this._getKey(this._array[i]) === e
                      );
                  ...
                  _process(e) {
                    ...
                    for (; this._i < this._tasks.length; ) {
                      if (
                        ...
                        this._tasks[this._i]() || this._i++,
                        1.5 *
                          (i = Math.max((t = Math.max(1, Date.now() - t)), i)) >
                          (r = e.timeRemaining()))
                      )
                        return (
                          s - t < -20 &&
              ...
              9092: (e, t, i) => {
                ...
                (t.MAX_BUFFER_SIZE = 4294967295),
                  (t.Buffer = class {
                    ...
                    _reflowLarger(e, t) {
                      let i = (0, a.reflowLargerGetLinesToRemove)(
                        this.lines,
                        this._cols,
                        e,
                        this.ybase + this.y,
                      ...
                      if (i.length > 0) {
                        let s = (0, a.reflowLargerCreateNewLayout)(
                          this.lines,
                          i
                        );
                    ...
                    _reflowLargerAdjustViewport(e, t, i) {
                      ...
                      for (; r-- > 0; )
                        0 === this.ybase
                          ? (this.y > 0 && this.y--,
                            this.lines.length < t &&
                              this.lines.push(new o.BufferLine(e, s)))
                    ...
                    _reflowSmaller(e, t) {
                      ...
                      for (let n = this.lines.length - 1; n >= 0; n--) {
                        ...
                        h =
                          0 === this.ybase && this.y !== this.lines.length - 1
                            ? Math.max(0, this.y - this.lines.maxLength + f)
                            : Math.max(
                                0,
                                this.lines.length - this.lines.maxLength + f
                              );
                        let v = [];
                        for (let e = 0; e < f; e++) {
                        ...
                        v.length > 0 &&
                          (s.push({ start: n + c.length + r, newLines: v }),
                          (r += v.length)),
                          c.push(...v);
                        let g = u.length - 1,
                          p = u[g];
                        ...
                        for (; m >= 0; ) {
                          ...
                          if (void 0 === c[g]) break;
                          if (
                            (c[g].copyCellsFrom(c[m], S - e, p - e, e, !0),
                            0 == (p -= e) && (p = u[--g]),
                            0 == (S -= e))
                          ) {
                            m--;
                      ...
                      if (s.length > 0) {
                        ...
                        let h = 0;
                        for (
                          let l = Math.min(this.lines.maxLength - 1, i + r - 1);
                          l >= 0;
                          l--
                        )
                          if (a && a.start > n + h) {
                            for (let e = a.newLines.length - 1; e >= 0; e--)
                              this.lines.set(l--, a.newLines[e]);
                            l++,
                              e.push({
                                index: n + 1,
              ...
              8437: (e, t, i) => {
                ...
                class h {
                  ...
                  copyFrom(e) {
                    for (let t in (this.length !== e.length
                  ...
                  clone() {
                    let e = new h(0);
                    for (let t in ((e._data = new Uint32Array(this._data)),
              ...
              4841: (e, t) => {
                Object.defineProperty(t, "__esModule", { value: !0 }),
                  ...
                  (t.getRangeLength = function (e, t) {
                    ...
                    return (
                      t * (e.end.y - e.start.y) + (e.end.x - e.start.x + 1)
                    );
                  });
              },
              4634: (e, t) => {
                    ...
                    for (let a = 0; a < e.length - 1; a++) {
                      ...
                      for (; u < c.length; ) {
                        let e = i(c, u, t),
                          ...
                          o = s - _,
                          a = Math.min(r, o);
                        c[d].copyCellsFrom(c[u], f, _, a, !1),
                          (_ += a) === s && (d++, (_ = 0)),
                          (f += a) === e && (u++, (f = 0)),
                          0 === _ &&
                            0 !== d &&
                            2 === c[d - 1].getWidth(s - 1) &&
                            (c[d].copyCellsFrom(c[d - 1], s - 1, _++, 1, !1),
                            c[d - 1].setCell(s - 1, n));
                      }
                      ...
                      for (
                        let e = c.length - 1;
                        e > 0 && (e > d || 0 === c[e].getTrimmedLength());
                        e--
                      )
                        v++;
                      v > 0 && (o.push(a + c.length - v), o.push(v)),
                        (a += c.length - 1);
                    }
                    return o;
                  }),
                ...
                class o extends n.AttributeData {
                  ...
                  setFromCharData(e) {
                    ...
                    t &&
                      ...
                      (this.content =
                        2097152 | (e[r.CHAR_DATA_WIDTH_INDEX] << 22)));
                  }
                  getAsCharData() {
                    return [
                      this.fg,
                ...
                t.evaluateKeyboardEvent = function (e, t, i, n) {
                  ...
                  switch (e.keyCode) {
                    ...
                    case 9:
                      ...
                      break;
                    case 13:
                      (o.key = e.altKey ? s.C0.ESC + s.C0.CR : s.C0.CR),
                        (o.cancel = !0);
                      break;
                    case 27:
                      (o.key = s.C0.ESC),
                      ...
                      if (!e.ctrlKey || e.shiftKey || e.altKey || e.metaKey) {
                        if ((i && !n) || !e.altKey || e.metaKey)
                          ...
                          if (i) o.key = s.C0.ESC + i;
                            ...
                            o.key = s.C0.ESC + (e.ctrlKey ? s.C0.NUL : " ");
                          else if (
                            "Dead" === e.key &&
                    ...
                    decode(e, t) {
                      ...
                      for (; d < i; ) {
                        ...
                        if ((s = e[d++]) < 128) t[a++] = s;
                          ...
                          if (d >= i)
                            return (
                              (this.interim[0] = s), (this.interim[1] = r), a
                            );
                          if (128 != (192 & (n = e[d++]))) {
                            d--;
                            continue;
                  ...
                  constructor() {
                    if (((this.version = "6"), !i)) {
                      (i = new Uint8Array(65536)).fill(1),
                        ...
                        (i[9001] = 2),
                        (i[9002] = 2),
                        i.fill(2, 11904, 42192),
                        (i[12351] = 1),
                        i.fill(2, 44032, 55204),
                        i.fill(2, 63744, 64256),
                        i.fill(2, 65040, 65050),
                        i.fill(2, 65072, 65136),
                        i.fill(2, 65280, 65377),
                        i.fill(2, 65504, 65511);
                      for (let e = 0; e < s.length; ++e)
                        i.fill(0, s[e][0], s[e][1] + 1);
                    }
                  }
                  wcwidth(e) {
                    return e < 32
                ...
                (t.parseColor = function (e) {
                  ...
                  if (0 === t.indexOf("rgb:")) {
                    ...
                    if (e) {
                      ...
                      return [
                        Math.round(
                          (parseInt(e[1] || e[4] || e[7] || e[10], 16) / t) *
                            255
                        ),
                        Math.round(
                          (parseInt(e[2] || e[5] || e[8] || e[11], 16) / t) *
                            255
                        ),
                        Math.round(
                          (parseInt(e[3] || e[6] || e[9] || e[12], 16) / t) *
                            255
                        ),
                      ];
                    }
              ...
              6351: (e, t, i) => {
                  ...
                  unhook(e, t = !0) {
                    if (this._active.length) {
                      ...
                      if (
                        ...
                        for (
                          ;
                          s >= 0 && !0 !== (i = this._active[s].unhook(e));
                          s--
                        )
                      ...
                      for (; s >= 0; s--)
                        if ((i = this._active[s].unhook(!1)) instanceof Promise)
                          return (
                            (this._stack.paused = !0),
                            (this._stack.loopPosition = s),
                ...
                a.addParam(0),
                  (t.DcsHandler = class {
                    ...
                    hook(e) {
                      (this._params =
                        e.length > 1 || e.params[0] ? e.clone() : a),
                        (this._data = ""),
                        (this._hitLimit = !1);
                    }
                    put(e, t, i) {
                    ...
                    unhook(e) {
                      ...
                      if (this._hitLimit) t = !1;
                        ...
                        e &&
                        (t = this._handler(this._data, this._params)) instanceof
                          Promise
                      )
                        return t.then(
                          (e) => (
              ...
              2015: (e, t, i) => {
                ...
                (t.TransitionTable = a),
                  (t.VT500_TRANSITION_TABLE = (function () {
                    ...
                    let o = s(0, 14);
                    for (e in (t.setDefault(1, 0), t.addMany(r, 0, 2, 0), o))
                      t.addMany([24, 26, 153, 154], e, 3, 0),
                        t.addMany(s(128, 144), e, 3, 0),
                        t.addMany(s(144, 152), e, 3, 0),
                        t.add(156, e, 0, 0),
                        t.add(27, e, 11, 1),
                        t.add(157, e, 4, 8),
                ...
                class h extends s.Disposable {
                  ...
                  _identifier(e, t = [64, 126]) {
                    ...
                    if (e.prefix) {
                      ...
                      if (((i = e.prefix.charCodeAt(0)) && 60 > i) || i > 63)
                      ...
                      switch (
                        ...
                        (n =
                          this._transitions.table[
                            (this.currentState << 8) | (r < 160 ? r : 160)
                          ]) >> 4)
                      ) {
                        case 2:
                          for (let s = i + 1; ; ++s)
                        ...
                        case 7:
                          ...
                          for (; a >= 0 && !0 !== (s = o[a](this._params)); a--)
                            if (s instanceof Promise)
                              return this._preserveStack(3, o, a, n, i), s;
                          a < 0 &&
                            this._csiHandlerFb(
                              (this._collect << 8) | r,
                              this._params
                        ...
                        case 10:
                          ...
                          for (; l >= 0 && !0 !== (s = h[l]()); l--)
                            if (s instanceof Promise)
                              return this._preserveStack(4, h, l, n, i), s;
                        ...
                        case 14:
                          if (
                            (s = this._dcsParser.unhook(24 !== r && 26 !== r))
                          )
                        ...
                        case 5:
                          ...
                          break;
                        case 6:
                          if ((s = this._oscParser.end(24 !== r && 26 !== r)))
                    ...
                    if (0 !== this._state) {
                      if (3 !== this._state) {
                        if (
                          ...
                          for (; s >= 0; s--)
                            if (
                              (i = this._active[s].end(!1)) instanceof Promise
                            )
                              return (
                                (this._stack.paused = !0),
                                (this._stack.loopPosition = s),
                  ...
                  (t.OscHandler = class {
                    ...
                    put(e, t, i) {
                      ...
                      if (this._hitLimit) t = !1;
                        ...
                        e &&
                        (t = this._handler(this._data)) instanceof Promise
                      )
                        return t.then(
                ...
                class i {
                  ...
                  toArray() {
                    ...
                    for (let t = 0; t < this.length; ++t) {
                      ...
                      s - i > 0 &&
                        e.push(
                          Array.prototype.slice.call(this._subParams, i, s)
                        );
                    }
                    return e;
                  }
                  ...
                  addParam(e) {
                    if (
                      ((this._digitIsSub = !1), this.length >= this.maxLength)
                    )
              ...
              7975: (e, t) => {
                Object.defineProperty(t, "__esModule", { value: !0 }),
                  ...
                  (t.ParserApi = class {
                    ...
                    registerDcsHandler(e, t) {
                      return this._core.registerDcsHandler(e, (e, i) =>
                        t(e, i.toArray())
                      );
                    }
                    addDcsHandler(e, t) {
              ...
              744: function (e, t, i) {
                ...
                let l = (t.BufferService = class extends o.Disposable {
                  ...
                  scroll(e, t = !1) {
                    let i;
                    let s = this.buffer;
                    ((i = this._cachedBlankLine) &&
                      i.length === this.cols &&
                      i.getFg(0) === e.fg &&
                      i.getBg(0) === e.bg) ||
                      ((i = s.getBlankLine(e, t)), (this._cachedBlankLine = i)),
                      (i.isWrapped = t);
                    ...
                    if (0 === s.scrollTop) {
                      ...
                      n === s.lines.length - 1
                        ? e
                          ? s.lines.recycle().copyFrom(i)
                          : s.lines.push(i.clone())
                        : s.lines.splice(n + 1, 0, i.clone()),
                        e
                      ...
                      let e = n - r + 1;
                      s.lines.shiftElements(r + 1, e - 1, -1),
                        s.lines.set(n, i.clone());
                    }
                  ...
                  scrollLines(e, t, i) {
                    ...
                    if (e < 0) {
                      ...
                      e + s.ydisp >= s.ybase && (this.isUserScrolling = !1);
                    let r = s.ydisp;
                  ...
                  _ = (t.CoreMouseService = class extends a.Disposable {
                    ...
                    triggerMouseEvent(e) {
                      if (
                        ...
                        (4 === e.button && 32 === e.action) ||
                        (3 === e.button && 32 !== e.action) ||
                        (4 !== e.button &&
                  ...
                  d = (t.CoreService = class extends a.Disposable {
                    constructor(e, t, i) {
                      super(),
                        ...
                        (this.modes = (0, n.clone)(l)),
                        (this.decPrivateModes = (0, n.clone)(c));
                    }
                    reset() {
                      (this.modes = (0, n.clone)(l)),
                        (this.decPrivateModes = (0, n.clone)(c));
              ...
              9074: (e, t, i) => {
                ...
                class l extends n.Disposable {
                  ...
                  *getDecorationsAtCell(e, t, i) {
                    ...
                    let o = 0,
                      a = 0;
                    for (let h of this._decorations.getKeyIterator(t))
                      (a =
                        (o =
                          null !== (s = h.options.x) && void 0 !== s ? s : 0) +
                        (null !== (r = h.options.width) && void 0 !== r
                          ? r
                          : 1)),
                        e >= o &&
                          e < a &&
                  ...
                  forEachDecorationAtCell(e, t, i, s) {
                    this._decorations.forEachByKey(t, (t) => {
                      ...
                      (h =
                        (a =
                          null !== (r = t.options.x) && void 0 !== r ? r : 0) +
                        (null !== (n = t.options.width) && void 0 !== n
                          ? n
                          : 1)),
                        e >= a &&
                          e < h &&
              ...
              4348: (e, t, i) => {
                ...
                class n {
                  constructor(...e) {
                    for (let [t, i] of ((this._entries = new Map()), e))
                      this.set(t, i);
                  }
                  set(e, t) {
                ...
                (t.ServiceCollection = n),
                  (t.InstantiationService = class {
                    ...
                    createInstance(e, ...t) {
                      let i = (0, r.getServiceDependencies)(e).sort(
                          (e, t) => e.index - t.index
                        ),
                        s = [];
                      for (let t of i) {
              ...
              7866: function (e, t, i) {
                ...
                let n = i(844),
                  ...
                  h,
                  l = (t.LogService = class extends n.Disposable {
                    get logLevel() {
                      ...
                      this._logLevel <= o.LogLevelEnum.TRACE &&
                        this._log(
                          null !==
                            (s =
                              null ===
                                (i = this._optionsService.options.logger) ||
                              void 0 === i
                                ? void 0
                                : i.trace.bind(
                                    this._optionsService.options.logger
                ...
                (t.LogService = l = s([r(0, o.IOptionsService)], l)),
                ...
                class a extends r.Disposable {
                  ...
                  _setupOptions() {
                    ...
                    for (let t in this.rawOptions) {
                      let s = { get: e.bind(this, t), set: i.bind(this, t) };
                    ...
                    switch (e) {
                      case "cursorStyle":
                        ...
                        if (
                          ...
                          throw Error(`"${i}" is not a valid value for ${e}`);
                        break;
                      case "wordSeparator":
                        i || (i = t.DEFAULT_OPTIONS[e]);
                        break;
                      ...
                      case "cols":
                        if (!i && 0 !== i)
                          throw Error(`${e} must be numeric, value: ${i}`);
                        break;
                      case "windowsPty":
                        i = null != i ? i : {};
                    }
                ...
                let n = i(2585),
                  o = (t.OscLinkService = class {
                    ...
                    registerLink(e) {
                      ...
                      if (s)
                        return this.addLineToLink(s.id, t.ybase + t.y), s.id;
                      ...
                      return (
                        r.onDispose(() => this._removeMarkerFromLink(n, r)),
                        this._entriesWithId.set(n.key, n),
                        this._dataByLinkId.set(n.id, n),
                        n.id
                      );
                    }
                    addLineToLink(e, t) {
                      ...
                      if (i && i.lines.every((e) => e.line !== t)) {
                        ...
                        i.lines.push(e),
                          e.onDispose(() => this._removeMarkerFromLink(i, e));
                      }
                    }
                    getLinkData(e) {
                      var t;
                ...
                (t.serviceRegistry = new Map()),
                  ...
                  (t.createDecorator = function (e) {
                    ...
                    let r = function (e, t, n) {
                      ...
                      e[i] === e
                        ? e[s].push({ id: r, index: n })
                        : ((e[s] = [{ id: r, index: n }]), (e[i] = e));
                    };
                    return (
                      (r.toString = () => e), t.serviceRegistry.set(e, r), r
                    );
                  });
              },
              2585: (e, t, i) => {
                ...
                (t.IBufferService = (0, n.createDecorator)("BufferService")),
                  (t.ICoreMouseService = (0, n.createDecorator)(
                    "CoreMouseService"
                  )),
                  (t.ICoreService = (0, n.createDecorator)("CoreService")),
                  (t.ICharsetService = (0, n.createDecorator)(
                    "CharsetService"
                  )),
                  (t.IInstantiationService = (0, n.createDecorator)(
                    "InstantiationService"
                  )),
                  ((r = s || (t.LogLevelEnum = s = {}))[(r.TRACE = 0)] =
                    "TRACE"),
                  (r[(r.DEBUG = 1)] = "DEBUG"),
                  (r[(r.INFO = 2)] = "INFO"),
                  (r[(r.WARN = 3)] = "WARN"),
                  ...
                  (t.IOptionsService = (0, n.createDecorator)(
                    "OptionsService"
                  )),
                  (t.IOscLinkService = (0, n.createDecorator)(
                    "OscLinkService"
                  )),
                  (t.IUnicodeService = (0, n.createDecorator)(
                    "UnicodeService"
                  )),
                  (t.IDecorationService = (0, n.createDecorator)(
                    "DecorationService"
                  ));
              },
              1480: (e, t, i) => {
          ...
          return (
            (() => {
              ...
              class c extends r.Disposable {
                constructor(e) {
                  super(),
                    (this._core = this.register(new t.Terminal(e))),
                    (this._addonManager = this.register(new n.AddonManager())),
                  ...
                  for (let e in this._core.options) {
                    let t = { get: i.bind(this, e), set: s.bind(this, e) };
                ...
                get parser() {
                  return (
                    this._parser ||
                      (this._parser = new a.ParserApi(this._core)),
                    this._parser
                  );
                }
                get unicode() {
                  ...
                  return (
                    this._buffer ||
                      (this._buffer = this.register(
                        new o.BufferNamespaceApi(this._core)
                      )),
                    this._buffer
                  );
                }

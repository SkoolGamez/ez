  ...
  [739],
  {
    9090: function (e, t, i) {
      ...
      (n.rBU.line = {
        worldUnits: { value: 1 },
        linewidth: { value: 1 },
        resolution: { value: new n.FM8(1, 1) },
        dashOffset: { value: 0 },
        dashScale: { value: 1 },
        dashSize: { value: 1 },
        gapSize: { value: 1 },
      ...
      function S(e, t, i) {
        return (
          w.set(0, 0, -t, 1).applyMatrix4(e.projectionMatrix),
          w.multiplyScalar(1 / w.w),
          (w.x = s / i.width),
          (w.y = s / i.height),
          w.applyMatrix4(e.projectionMatrixInverse),
          w.multiplyScalar(1 / w.w),
          Math.abs(Math.max(w.x, w.y))
        );
      }
      class x extends n.Kj0 {
        constructor(
          e = new a.z(),
          t = new o({ color: 16777215 * Math.random() })
        ) {
          super(e, t),
        ...
        computeLineDistances() {
          ...
          for (let e = 0, s = 0, n = t.count; e < n; e++, s += 2)
            l.fromBufferAttribute(t, e),
              d.fromBufferAttribute(i, e),
              (r[s] = 0 === s ? 0 : r[s - 1]),
              (r[s + 1] = r[s] + l.distanceTo(d));
          let s = new n.$TI(r, 2, 1);
          return (
            e.setAttribute("instanceDistanceStart", new n.kB5(s, 1, 0)),
            e.setAttribute("instanceDistanceEnd", new n.kB5(s, 1, 1)),
            this
          );
        }
        raycast(e, t) {
          ...
          if (
            ...
            y.copy(x.boundingSphere).applyMatrix4(w),
            o)
          )
            i = 0.5 * s;
          else {
          ...
          if (((y.radius += i), !1 !== r.intersectsSphere(y))) {
            if (
              ...
              g.copy(x.boundingBox).applyMatrix4(w),
              o)
            )
              a = 0.5 * s;
            else {
              ...
              !1 !== r.intersectsBox(g) &&
                (o
                  ...
                  : (function (e, t, i) {
                      ...
                      r.at(1, h),
                        (h.w = 1),
                        h.applyMatrix4(t.matrixWorldInverse),
                        h.applyMatrix4(a),
                        ...
                        (h.z = 0),
                        f.copy(h),
                        p.multiplyMatrices(t.matrixWorldInverse, d);
                      for (let t = 0; t < S; t++) {
                        c.fromBufferAttribute(y, t),
                          u.fromBufferAttribute(w, t),
                          (c.w = 1),
                          (u.w = 1),
                          c.applyMatrix4(p),
                          u.applyMatrix4(p);
                        ...
                        let g = n.M8C.lerp(c.z, u.z, h),
                          S = g >= -1 && g <= 1,
                          b = f.distanceTo(v) < 0.5 * s;
                        if (S && b) {
                          m.start.fromBufferAttribute(y, t),
                            m.end.fromBufferAttribute(w, t),
                            m.start.applyMatrix4(d),
                            m.end.applyMatrix4(d);
                          let s = new n.Pa4(),
                            a = new n.Pa4();
                          r.distanceSqToSegment(m.start, m.end, a, s),
                            i.push({
                              point: a,
                              pointOnLine: s,
    ...
    8671: function (e, t, i) {
      ...
      class a extends r.L5s {
        ...
        setPositions(e) {
          ...
          return (
            this.setAttribute("instanceStart", new r.kB5(i, 3, 0)),
            this.setAttribute("instanceEnd", new r.kB5(i, 3, 3)),
        ...
        setColors(e) {
          ...
          let i = new r.$TI(t, 6, 1);
          return (
            this.setAttribute("instanceColorStart", new r.kB5(i, 3, 0)),
            this.setAttribute("instanceColorEnd", new r.kB5(i, 3, 3)),
            this
          );
        }
        ...
        computeBoundingBox() {
          ...
          void 0 !== e &&
            ...
            s.setFromBufferAttribute(t),
            this.boundingBox.union(s));
        }
        computeBoundingSphere() {
          null === this.boundingSphere && (this.boundingSphere = new r.aLr()),
            null === this.boundingBox && this.computeBoundingBox();
          let e = this.attributes.instanceStart,
            t = this.attributes.instanceEnd;
          if (void 0 !== e && void 0 !== t) {
            ...
            for (let s = 0, a = e.count; s < a; s++)
              n.fromBufferAttribute(e, s),
                (r = Math.max(r, i.distanceToSquared(n))),
                n.fromBufferAttribute(t, s),
                (r = Math.max(r, i.distanceToSquared(n)));
      ...
      class o {
        constructor(e, t) {
          ...
          (this.renderTarget1 = t),
            ...
            (this.passes = []),
            (this.copyPass = new n.T(s)),
            (this.copyPass.material.blending = r.jFi),
        ...
        render(e) {
          ...
          for (let t = 0, r = this.passes.length; t < r; t++) {
            ...
            if (!1 !== r.enabled) {
              ...
              void 0 !== a.F &&
                (r instanceof a.F ? (i = !0) : r instanceof a.M && (i = !1));
            }
          }
    ...
    8304: function (e, t, i) {
      ...
      let n = new r.iKG(-1, 1, 1, -1, 0, 1),
        a = new r.u9r();
      a.setAttribute("position", new r.a$l([-1, 3, 0, -1, -1, 0, 3, -1, 0], 3)),
        a.setAttribute("uv", new r.a$l([0, 2, 0, 0, 2, 0], 2));
      class o {
        constructor(e) {
        ...
        constructor(e, t) {
          super(),
            ...
            e instanceof r.jyz
              ...
              : e &&
                ((this.uniforms = r.rDY.clone(e.uniforms)),

      ...
      class i extends s.aNw {
        ...
        decodeGeometry(e, t) {
          ...
          let i = this.workerNextTaskID++,
            o = e.byteLength,
            a = this._getWorker(i, o)
              .then(
                (s) => (
                  (r = s),
                  new Promise((s, n) => {
                    (r._callbacks[i] = { resolve: s, reject: n }),
                      r.postMessage(
        ...
        _createGeometry(e) {
          ...
          for (let r = 0; r < e.attributes.length; r++) {
            let n = e.attributes[r],
              ...
              l = new s.TlE(o, a);
            "color" === i &&
              (this._assignVertexColorSpace(l, n.vertexColorSpace),
              (l.normalized = o instanceof Float32Array == !1)),
              t.setAttribute(i, l);
          }
          return t;
        }
        _assignVertexColorSpace(e, t) {
          ...
          for (let t = 0, s = e.count; t < s; t++)
            r.fromBufferAttribute(e, t).convertSRGBToLinear(),
                ...
                try {
                  let e = (function (e, t, r, s) {
                      ...
                      if (l === e.TRIANGULAR_MESH)
                        (n = new e.Mesh()),
                          (i = t.DecodeArrayToMesh(r, r.byteLength, n));
                      else if (l === e.POINT_CLOUD)
                        (n = new e.PointCloud()),
                          (i = t.DecodeArrayToPointCloud(r, r.byteLength, n));
                      else
                        throw Error(
                      ...
                      if (!i.ok() || 0 === n.ptr)
                        throw Error(
                          "THREE.DRACOLoader: Decoding failed: " + i.error_msg()
                        );
                      ...
                      for (let r in o) {
                        ...
                        let c = self[a[r]];
                        if (s.useUniqueIDs)
                          (l = o[r]), (i = t.GetAttributeByUniqueId(n, l));
                        else {
                          if (-1 === (l = t.GetAttributeId(n, e[o[r]])))
                            continue;
                        ...
                        let h = (function (e, t, r, s, n, i) {
                          ...
                          return e._free(h), { name: s, array: d, itemSize: o };
                        })(e, t, n, r, c, i);
                        "color" === r &&
                          (h.vertexColorSpace = s.vertexColorSpace),
                          u.attributes.push(h);
                      }
                      return (
                        l === e.TRIANGULAR_MESH &&
    ...
    7836: function (e, t, r) {
      ...
      class l {
        ...
        _loadLight(e) {
          ...
          void 0 !== u.color &&
            c.setRGB(u.color[0], u.color[1], u.color[2], s.GUF);
          ...
          switch (u.type) {
            ...
            case "point":
              ...
              break;
            case "spot":
              ((t = new s.PMe(c)).distance = h),
                (u.spot = u.spot || {}),
                (u.spot.innerConeAngle =
                  void 0 !== u.spot.innerConeAngle ? u.spot.innerConeAngle : 0),
                (u.spot.outerConeAngle =
                  void 0 !== u.spot.outerConeAngle
                    ? u.spot.outerConeAngle
                    : Math.PI / 4),
                (t.angle = u.spot.outerConeAngle),
                (t.penumbra =
                  1 - u.spot.innerConeAngle / u.spot.outerConeAngle),
          ...
          return (
            ...
            (t.decay = 2),
            K(t, u),
            void 0 !== u.intensity && (t.intensity = u.intensity),
            (t.name = r.createUniqueName(u.name || "light_" + e)),
            (i = Promise.resolve(t)),
            r.cache.add(n, i),
            i
          );
        ...
        extendParams(e, t, r) {
          ...
          if (i) {
            ...
            void 0 !== i.baseColorTexture &&
              n.push(r.assignTexture(e, "map", i.baseColorTexture, s.KI_));
          }
        ...
        extendMaterialParams(e, t) {
          ...
          return (
            ...
            void 0 !== i.iridescenceTexture &&
              n.push(
                r.assignTexture(t, "iridescenceMap", i.iridescenceTexture)
              ),
            void 0 !== i.iridescenceIor &&
              (t.iridescenceIOR = i.iridescenceIor),
        ...
        extendMaterialParams(e, t) {
          ...
          return (
            ...
            void 0 !== o.sheenColorTexture &&
              i.push(
                r.assignTexture(t, "sheenColorMap", o.sheenColorTexture, s.KI_)
              ),
      ...
      class f {
        ...
        extendMaterialParams(e, t) {
          ...
          return (
            (t.attenuationColor = new s.Ilk().setRGB(a[0], a[1], a[2], s.GUF)),
            Promise.all(i)
          );
        }
      }
      ...
      class g {
        ...
        extendMaterialParams(e, t) {
          ...
          return (
            (t.specularColor = new s.Ilk().setRGB(a[0], a[1], a[2], s.GUF)),
          ...
          if (!r.extensions || !r.extensions[this.name]) return null;
          {
            ...
            return s.then(function (t) {
              ...
              return n.decodeGltfBufferAsync
                ? n
                    .decodeGltfBufferAsync(i, o, a, e.mode, e.filter)
                    .then(function (e) {
                      return e.buffer;
                    })
      ...
      class y {
        ...
        createNodeMesh(e) {
          ...
          for (let e of n.primitives)
            if (
              e.mode !== P.TRIANGLES &&
              e.mode !== P.TRIANGLE_STRIP &&
              e.mode !== P.TRIANGLE_FAN &&
              void 0 !== e.mode
            )
              return null;
            ...
            : (a.push(this.parser.createNodeMesh(e)),
              Promise.all(a).then((e) => {
                ...
                for (let e of r) {
                  ...
                  for (let e = 0; e < n; e++)
                    l.TRANSLATION && r.fromBufferAttribute(l.TRANSLATION, e),
                      l.ROTATION && o.fromBufferAttribute(l.ROTATION, e),
                      l.SCALE && a.fromBufferAttribute(l.SCALE, e),
                      u.setMatrixAt(e, t.compose(r, o, a));
                  for (let t in l)
                    "TRANSLATION" !== t &&
                      "ROTATION" !== t &&
                      "SCALE" !== t &&
                      e.geometry.setAttribute(t, l[t]);
                  s.Tme.prototype.copy.call(u, e),
      ...
      let P = {
        ...
        H = { 33071: s.uWy, 33648: s.OoA, 10497: s.rpg },
        U = {
          SCALAR: 1,
          VEC2: 2,
          VEC3: 3,
        ...
        G = { CUBICSPLINE: void 0, LINEAR: s.NMF, STEP: s.Syv },
        B = { OPAQUE: "OPAQUE", MASK: "MASK", BLEND: "BLEND" };
      function j(e, t, r) {
        for (let s in r.extensions)
          void 0 === e[s] &&
      ...
      class W {
        constructor(e = {}, t = {}) {
          ...
          "undefined" != typeof navigator &&
            ...
            (this.fileLoader = new s.hH6(this.options.manager)),
        ...
        _getNodeRef(e, t, r) {
          ...
          let s = r.clone(),
            n = (e, t) => {
              ...
              for (let [s, i] of (null != r && this.associations.set(t, r),
              e.children.entries()))
                n(i, t.children[s]);
            };
            ...
            Promise.all(i).then(function (e) {
              ...
              if (p && p !== h) {
                let e = Math.floor(d / p),
                  ...
                  h = t.cache.get(r);
                h ||
                  ((i = new u(a, e * p, (n.count * p) / c)),
                  (h = new s.vpT(i, p / c)),
                  t.cache.add(r, h)),
                  (o = new s.kB5(h, l, (d % p) / c, m));
              ...
              if (void 0 !== n.sparse) {
                ...
                null !== a &&
                  (o = new s.TlE(o.array.slice(), o.itemSize, o.normalized));
                for (let e = 0, t = h.length; e < t; e++) {
                  let t = h[e];
                  if (
                    (o.setX(t, d[e * l]),
                    l >= 2 && o.setY(t, d[e * l + 1]),
                    l >= 3 && o.setZ(t, d[e * l + 2]),
                    l >= 4 && o.setW(t, d[e * l + 3]),
                    l >= 5)
                  )
                    throw Error(
          ...
          let u = this.loadImageSource(t, r)
            .then(function (t) {
              ...
              let r = i.samplers || {},
                l = r[o.sampler] || {};
              return (
                (t.magFilter = O[l.magFilter] || s.wem),
                (t.minFilter = O[l.minFilter] || s.D1R),
                (t.wrapS = H[l.wrapS] || s.rpg),
                (t.wrapT = H[l.wrapT] || s.rpg),
        ...
        loadImageSource(e, t) {
          ...
          if (void 0 !== i.bufferView)
            a = this.getDependency("bufferView", i.bufferView).then(function (
              e
            ) {
              l = !0;
              let t = new Blob([e], { type: i.mimeType });
          ...
          return this.getDependency("texture", r.index).then(function (i) {
            ...
            if (
              ...
              if (e) {
                ...
                (i = n.extensions[a.KHR_TEXTURE_TRANSFORM].extendTexture(i, e)),
                  n.associations.set(i, t);
              }
            }
        ...
        loadMaterial(e) {
          ...
          if (u[a.KHR_MATERIALS_UNLIT]) {
            ...
            void 0 !== n.baseColorTexture &&
              c.push(r.assignTexture(l, "map", n.baseColorTexture, s.KI_)),
              (l.metalness =
              ...
              void 0 !== n.metallicRoughnessTexture &&
                (c.push(
                  r.assignTexture(l, "metalnessMap", n.metallicRoughnessTexture)
                ),
                c.push(
                  r.assignTexture(l, "roughnessMap", n.metallicRoughnessTexture)
                )),
          ...
          if (
            ...
            void 0 !== o.normalTexture &&
              t !== s.vBJ &&
              (c.push(r.assignTexture(l, "normalMap", o.normalTexture)),
              (l.normalScale = new s.FM8(1, 1)),
          ...
          if (
            (void 0 !== o.occlusionTexture &&
              t !== s.vBJ &&
              (c.push(r.assignTexture(l, "aoMap", o.occlusionTexture)),
              void 0 !== o.occlusionTexture.strength &&
                (l.aoMapIntensity = o.occlusionTexture.strength)),
            void 0 !== o.emissiveFactor && t !== s.vBJ)
          ) {
          ...
          return (
            void 0 !== o.emissiveTexture &&
              t !== s.vBJ &&
              c.push(
                r.assignTexture(l, "emissiveMap", o.emissiveTexture, s.KI_)
              ),
            Promise.all(c).then(function () {
              ...
              return (
                ...
                K(s, o),
                r.associations.set(s, { materials: e }),
                o.extensions && j(i, s, o),
                s
              );
            })
          );
          ...
          for (let o = 0, l = e.length; o < l; o++) {
            let l = e[o],
              u = (function (e) {
                let t;
                let r =
                  e.extensions && e.extensions[a.KHR_DRACO_MESH_COMPRESSION];
                if (
                  ((t = r
                    ? "draco:" +
                      r.bufferView +
                  ...
                  for (let r = 0, s = e.targets.length; r < s; r++)
                    t += ":" + V(e.targets[r]);
                return t;
              })(l),
              c = n[u];
            if (c) i.push(c.promise);
              ...
              let e;
              (e =
                l.extensions && l.extensions[a.KHR_DRACO_MESH_COMPRESSION]
                  ? (function (e) {
          ...
          return (
            ...
            Promise.all(l).then(function (r) {
              ...
              for (let r = 0, h = u.length; r < h; r++) {
                ...
                if (
                  p.mode === P.TRIANGLES ||
                  p.mode === P.TRIANGLE_STRIP ||
                  p.mode === P.TRIANGLE_FAN ||
                  void 0 === p.mode
                )
                  !0 ===
                    (h =
                      !0 === o.isSkinnedMesh
                        ? new s.TUv(d, m)
                        : new s.Kj0(d, m)).isSkinnedMesh &&
                    h.normalizeSkinWeights(),
                    p.mode === P.TRIANGLE_STRIP
                      ? (h.geometry = n(h.geometry, s.UlW))
                      : p.mode === P.TRIANGLE_FAN &&
                        (h.geometry = n(h.geometry, s.z$h));
                ...
                Object.keys(h.geometry.morphAttributes).length > 0 &&
                  ...
                  (h.name = t.createUniqueName(o.name || "mesh_" + e)),
                  K(h, o),
                  p.extensions && j(i, h, p),
              ...
              let h = new s.ZAu();
              o.extensions && j(i, h, o), t.associations.set(h, { meshes: e });
        ...
        loadNode(e) {
          ...
          let o =
            void 0 === r.skin
              ...
              : this.getDependency("skin", r.skin);
        ...
        loadScene(e) {
          ...
          r.name && (i.name = n.createUniqueName(r.name)),
            K(i, r),
            r.extensions && j(t, i, r);
          let o = r.nodes || [],
            a = [];
          for (let e = 0, t = o.length; e < t; e++)
            a.push(n.getDependency("node", o[e]));
            ...
            return (
              (n.associations = ((e) => {
                ...
                for (let [e, r] of n.associations)
                  (e instanceof s.F5T || e instanceof s.xEZ) && t.set(e, r);
                return (
                  e.traverse((e) => {
      ...
      function z(e, t, r) {
        ...
        return (
          s.epp.workingColorSpace !== s.GUF &&
            "COLOR_0" in n &&
            console.warn(
              `THREE.GLTFLoader: Converting vertex colors from "srgb-linear" to "${s.epp.workingColorSpace}" not supported.`
            ),
          K(e, t),
          !(function (e, t, r) {
            let n = t.attributes,
